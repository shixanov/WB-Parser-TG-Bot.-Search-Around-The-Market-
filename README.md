...
##  main functions
- **поиск товаров:** парсинг WB по ключевым словам, выдача информации в виде списка
- **лимиты:**  20 запросов в день максимум
- **история:** вся история запросов пользователей хранится в json файле
- **админка:** связь с поддержкой, напрямую через тг-юз, и через сообщение в бота, где бот передает уже в отдельную конфу

## stack
- **язык:** Python 3.10+
- **библиотека бота:** aiogram 3.16.0
